...
/// A shared dependency is a dependency that, when someone wants to use your lib as a dependency, is used for more dependency resolution, and to check out how it was configured when you generated the library
