...
impl ToString for Module {
    fn to_string(&self) -> String {
        ...
        {
            result.push_str(&format!("LOCAL_EXPORT_C_INCLUDES := {}\n", self.export_includes));
        }
...
impl AndroidMk {
    ...
    fn from_str(s: &str) -> AndroidMk
    {
        ...
        let mut mk = AndroidMk { ..Default::default() };
        ...
        for line in lines.iter()
        {
            ...
            {
                // Check if mod end
                if line.starts_with("include $(") || line.starts_with("rwildcard=$") || line.starts_with("LOCAL_PATH") || line.starts_with("TARGET_ARCH_ABI")
                {
